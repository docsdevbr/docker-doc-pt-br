...
1. Open your CLI terminal and start a container by using the [`docker run`](../../../reference/cli/docker/container/run.md) command:
...
You can verify if the container is up and running by using the [`docker ps`](../../../reference/cli/docker/container/ls.md) command:
...
2. Provide the container ID or name to the [`docker stop`](../../../reference/cli/docker/container/stop.md) command:
...
- [Running a container](../../../reference/cli/docker/container/run.md)
