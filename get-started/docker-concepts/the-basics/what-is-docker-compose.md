...
4. Use the [`docker compose up`](../../../reference/cli/docker/compose/up.md) command to start the application:
...
1. In the CLI, use the [`docker compose down`](../../../reference/cli/docker/compose/down.md) command to remove everything:
