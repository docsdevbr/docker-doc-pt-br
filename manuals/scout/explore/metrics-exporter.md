...
To create a PAT, follow the steps in [Create an access token](../../security/for-developers/access-tokens.md#create-an-access-token).
...
2. [Create a Docker access token](../../security/for-developers/access-tokens.md#create-an-access-token)
...
To revoke a PAT, follow the steps in the [Create and manage access tokens](../../security/for-developers/access-tokens.md#modify-existing-tokens).
