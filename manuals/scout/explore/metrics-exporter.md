...
To create a PAT, follow the steps in [Create an access token](../../security/for-developers/access-tokens/index.md#create-an-access-token).
...
2. [Create a Docker access token](../../security/for-developers/access-tokens/index.md#create-an-access-token)
...
To revoke a PAT, follow the steps in the [Create and manage access tokens](../../security/for-developers/access-tokens/index.md#modify-existing-tokens).
