...
For detailed prerequisites and instructions on how to enable SSO, see [Configure Single Sign-on](../../for-admins/single-sign-on/configure/).
...
[SCIM](../../for-admins/provisioning/scim/) is available to provide full synchronization with users and groups. When you auto-provision users with SCIM, the recommended configuration is to disable JIT so that all auto-provisioning is handled by SCIM.
...
See [SSO authentication with JIT provisioning disabled](../for-admins/provisioning/just-in-time/index.md#sso-authentication-with-jit-provisioning-disabled).

To auto-provision users without JIT provisioning, you can use [SCIM](../for-admins/provisioning/scim/index.md).
