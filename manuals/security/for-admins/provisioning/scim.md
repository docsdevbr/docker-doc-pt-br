...
For additional details about supported attributes and SCIM, see [Docker Hub API SCIM reference](../../../reference/api/hub/latest/index.md#tag/scim).
...
You must make sure you have [configured SSO](../single-sign-on/configure/) before you enable SCIM. Enforcing SSO isn't required.
...
1. Setup [SSO](../single-sign-on/configure/) and SCIM first.
