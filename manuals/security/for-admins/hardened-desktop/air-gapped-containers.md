...
Assuming [enforced sign-in](../../../manuals/security/for-admins/enforce-sign-in/) and [Settings Management](settings-management/index.md) are enabled, add the new proxy configuration to the `admin-settings.json` file. For example:
