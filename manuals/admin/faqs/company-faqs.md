...
To view and manage users across all the organizations under your company, you can [manage users at the company level](../company/users.md) when you use the [Admin Console](https://admin.docker.com).
...
You can add organizations to a company in the [Admin Console](../company/organizations.md#add-organizations-to-a-company) or [Docker Hub](../company/new-company.md#add-organizations-to-a-company).
