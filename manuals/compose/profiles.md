...
To start a specific profile supply the `--profile` [command-line option](reference/) or
...
As with starting specific profiles, you can use the `--profile` [command-line option](reference/) or
use the [`COMPOSE_PROFILES` environment variable](environment-variables/envvars.md#compose_profiles):
