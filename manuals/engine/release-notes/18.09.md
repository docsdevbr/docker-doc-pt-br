...
For more information on the list of deprecated flags and APIs, have a look at the [deprecation information](../deprecated/index.md) where you can find the target removal dates.
