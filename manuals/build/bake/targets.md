...
For all the properties you can set for a target, see the [Bake reference](../../../manuals/build/bake/reference#target).
...
- Head to the [Bake file reference](../../../manuals/build/bake/reference/index.md) to learn about all
