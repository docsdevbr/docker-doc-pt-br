...
For all the properties you can set for a target, see the [Bake reference](reference.md#target).
...
- Head to the [Bake file reference](reference.md) to learn about all
