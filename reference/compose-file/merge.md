...
For more information on how merge can be used to create a composite Compose file, see [Working with multiple Compose files](../../manuals/compose/how-tos/multiple-compose-files/index.md)
