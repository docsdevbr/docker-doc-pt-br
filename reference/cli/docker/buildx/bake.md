---
source_url: https://github.com/docker/buildx/blob/master/docs/reference/buildx_bake.md
revision: f369377d7412241fc3684687a674f2b8dd66552c
status: untranslated
...
Same as [`build --call`](build.md#call).

#### <a name="check"></a> Call: check (--check)

Same as [`build --check`](build.md#check).
...
Similar to [`buildx build --metadata-file`](build.md#metadata-file) but
...
Same as [`build --progress`](build.md#progress).

### <a name="provenance"></a> Create provenance attestations (--provenance)

Same as [`build --provenance`](build.md#provenance).
...
Same as [`build --sbom`](build.md#sbom).
