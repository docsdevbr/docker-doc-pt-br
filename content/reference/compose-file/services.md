...
Uma definição de serviço contém a configuração que é aplicada a cada contêiner
de serviço.
...
[Especificação do Compose Build](build.md).
...
descrito em detalhes na documentação da
[Especificação do Compose Deploy](deploy.md).
